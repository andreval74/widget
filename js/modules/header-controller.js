...
class HeaderController {
    ...
    updateConnectButton() {
        ...
        switch (this.currentState) {
            case this.states.CONNECTED:
                ...
                btn.title = `Conectado: ${account}\nClique para dashboard`;
                btn.disabled = false;
                break;
                
            case this.states.CONNECTING:
                btn.className = 'btn btn-sm wallet-btn';
                btn.innerHTML = '<i class="fas fa-spinner fa-spin me-1"></i><span>Conectando...</span>';
            ...
            case this.states.ERROR:
                btn.className = 'btn btn-sm wallet-btn';
                btn.innerHTML = '<i class="fas fa-exclamation-triangle me-1"></i><span>Erro</span>';
            ...
            default: // DISCONNECTED
                btn.className = 'btn btn-sm wallet-btn';
                btn.innerHTML = '<i class="fas fa-wallet me-1"></i><span>Conectar</span>';
    ...
    updateLanguageFlag() {
        ...
        // Usando o padrão XCafe com dropdown de idiomas
        btn.innerHTML = '<span id="current-flag">🇧🇷</span><span class="d-none d-md-inline ms-1" id="current-lang">PT</span>';
        btn.title = 'Selecionar Idioma';
        btn.className = 'btn btn-sm btn-primary dropdown-toggle language-btn';
        
        // Habilitar o sistema de idiomas
        btn.disabled = false;
    }
